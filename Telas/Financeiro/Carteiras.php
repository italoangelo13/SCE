...
<div class="row bg-fariamodas text-fariamodas-gold">
    <div class="col-lg-12 text-lg-right text-center">
        <h5>Gestão de Carteiras</h5>
    </div>
</div>

<div class="row alert alert-info">
    <div class="col-lg-12 text-center">No Painel de Gestão de Carteiras, você poderá Cadastrar, alterar, Pesquisar
        e excluir suas carteiras. Estas Carteiras São responsaveis por separar todos os movimentos financeiros registrados no fluxo de caixa.</div>
</div>
    ...
    <div class="row alert-secondary" style="padding: 10px;">
        <div class="col-lg-12">
            <div class="btn btn-primary " onclick="Cadastrar()">
                <i class="icone-plus"></i> Cadastrar Carteira
            </div>
        </div>
    </div>
